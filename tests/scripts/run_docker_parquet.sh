...
CONFIG_FILE="tests/resources/configs/integration/config_docker_parquet_no_hash.yaml"
OUTPUT_DIR="./export_docker_parquet"

echo "Running Oracle Data Exporter (Rust) with Docker Test Config (Parquet, No Hash)..."
